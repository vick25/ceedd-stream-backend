...
class ZoneContributive(models.Model):
    ...
    etat_ravin = models.CharField(
        max_length=50, choices=[("actif", "Actif"), ("stable", "Stable")], blank=True
    )
    description = models.TextField(blank=True)
    # geom = models.MultiPolygonField(srid=4326, null=True, blank=True)
    shapefile_id = models.ForeignKey(
        Shp, on_delete=models.SET_NULL, blank=True, null=True
    )
...
class Finance(models.Model):
    ...
    unite_monnaie = models.CharField(
        max_length=10,
...
class Inspection(models.Model):
    infrastructure = models.ForeignKey(
        Infrastructure, on_delete=models.CASCADE, related_name="inspections"
    )
